...
class Settings(BaseSettings):
    ...
    WORKFLOWS_DIR: str = str(ROOT_DIR / "data" / "workflows")
    LEARNING_DIR: str = str(ROOT_DIR / "data" / "learning")
    OS_DIR: str = str(ROOT_DIR / "data" / "os")
    ...
    def ensure_directories(self) -> None:
        ...
        Path(self.LEARNING_DIR).mkdir(parents=True, exist_ok=True)
        Path(self.OS_DIR).mkdir(parents=True, exist_ok=True)
